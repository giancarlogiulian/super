...
<?php
     ...
     $Query = "SELECT * FROM clientes"; // Comando para fazer a consulta armazenada na variável $Query
     ...
     print("<TR>");
     print("<TH>Código</TH><TH>Nome</TH><TH>Cidade</TH><TH>UF</TH>
...
?>
     ...
     <center><a href=opcoes.html><img src="../botoes/administrador/administrator.png"></img>Administração do SGBD</a></center>
</html>
