...
<?php
     ...
     $Query = "SELECT CodProduto, Nome, Valor FROM produtos"; // Comando para fazer a consulta armazenada na variável $Query
     ...
     print("<BR><center><font color=red>Produtos</font><BR><BR></center>");
     ...
     print("<TR>");
     print("<TH>Código</TH><TH>Categoria</TH><TH>Nome</TH><TH>Valor</TH><TH>COMPRAR</TH>"); // TH celula negritada
     print("</TR>");
     while ($Registros=mysql_fetch_array($Resultado))
     {
          ...
          print("<TD><a href=carrinho.php?CodProduto=$Registros[CodProduto]><center><img src=botoes/listas/cart_add.png></img></center></a></TD>");
          print ("</TR>");
     }
     print("</TABLE>");
     print("</center>");
...
<br><center><a href="login.htm"><img src="botoes/logout/door_out.png"</img> Sair</a></center>
</html>
